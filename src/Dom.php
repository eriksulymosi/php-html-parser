 ...
 * Class Dom.
 */
class Dom implements DomInterface, Stringable
{
    use RootAccessTrait;
    ...
    {
        $this->domParser = $domParser ?? DomParserDiscovery::find();
        $this->domCleaner = $domCleaner ?? CleanerDiscovery::find();
    }
    ...
    public function loadStr(string $str, ?Options $options = null): Dom
    {
        ...
        if ($this->globalOptions instanceof Options) {
